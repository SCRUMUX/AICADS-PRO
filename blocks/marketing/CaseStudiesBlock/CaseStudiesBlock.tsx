...
import { BlogChevronLeftIcon, BlogChevronRightIcon } from '../BlogBlock/BlogBlockIcons';
import { CaseStudyCard } from './CaseStudyCard';
import type { CaseStudiesBlockProps } from './CaseStudiesBlock.types';
...
function CaseStudyCardList({ cases }: Pick<CaseStudiesBlockProps, 'cases'>) {
  return (
    <>
      {cases.map((item) => (
...
CaseStudiesBlock.displayName = 'CaseStudiesBlock';
