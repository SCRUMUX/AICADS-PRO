...
import { aicadsCaseStudyHeroBackgrounds } from '../demo-assets/aicadsCaseStudyDemoImages';
...
export const CaseDetailPageTemplate: React.FC<CaseDetailPageTemplateProps> = ({
  navbar,
  hero,
  intro,
  anchorNav,
  ...
  contactHero,
  footer,
  closingBackgroundImage = aicadsCaseStudyHeroBackgrounds.closing,
  heroBackgroundImage = aicadsCaseStudyHeroBackgrounds.case,
  className,
}) => (
  <div className={cn('min-h-[100svh] bg-[var(--color-surface-1)]', className)} aria-label="Case study detail">
    <NavbarBlock {...navbar} />
    <MarketingAboveFold
      underFixedNavbar
...
CaseDetailPageTemplate.displayName = 'CaseDetailPageTemplate';
