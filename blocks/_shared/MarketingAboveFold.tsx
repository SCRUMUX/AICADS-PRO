...
import { PhotoHeroBackdrop, type PhotoHeroBackdropProps, type PhotoHeroTone } from './PhotoHeroBackdrop';
...
export const MarketingAboveFold: React.FC<MarketingAboveFoldProps> = ({
  ...
  const parallaxRef = useParallaxOffset(backgroundImageSrc ? 0 : 0.1, !backgroundImageSrc);
